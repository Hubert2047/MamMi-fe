...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  const adminOnlyRoutes = ['/admin/store-pricing', '/admin/employees', '/admin/expenses', '/admin/inventory', '/admin/inventory-receipts', '/admin/stocktakes', '/admin/revenues', '/admin/orders', '/admin/daily-closing', '/admin/settings']
