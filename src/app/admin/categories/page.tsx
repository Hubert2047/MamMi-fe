...
export default function CategoriesPage() {
  const client = useQueryClient(); const { t, locale } = useI18n(); const [names, setNames] = useState<CategoryNames>(emptyNames); const [editing, setEditing] = useState<Category | null>(null)
