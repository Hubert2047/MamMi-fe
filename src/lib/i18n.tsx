...
const storeProductMessages = {
  vi: {
    ...
    overviewFrom: "Từ",
    overviewTo: "Đến",
    overviewApplyFilter: "Áp dụng",
    overviewFilterReset: "Xóa bộ lọc",
    overviewPreviousDay: "Ngày trước",
    overviewNextDay: "Ngày sau",
  ...
  en: {
    ...
    overviewFrom: "From",
    overviewTo: "To",
    overviewApplyFilter: "Apply",
    overviewFilterReset: "Clear filters",
    overviewPreviousDay: "Previous day",
    overviewNextDay: "Next day",
  ...
  "zh-TW": {
    ...
    overviewFrom: "從",
    overviewTo: "到",
    overviewApplyFilter: "套用",
    overviewFilterReset: "清除篩選",
    overviewPreviousDay: "前一天",
    overviewNextDay: "後一天",
...
Object.assign(orderMessages.vi, {
  ...
  orderFrom: "Từ",
  orderTo: "Đến",
  orderApplyFilter: "Áp dụng",
  orderFilterReset: "Xóa bộ lọc",
  orderPreviousDay: "Ngày trước",
  orderNextDay: "Ngày sau",
  adminOrdersAmount: "Tổng tiền",
...
Object.assign(orderMessages.en, {
  ...
  orderFrom: "From",
  orderTo: "To",
  orderApplyFilter: "Apply",
  orderFilterReset: "Clear filters",
  orderPreviousDay: "Previous day",
  orderNextDay: "Next day",
  adminOrdersAmount: "Total amount",
...
Object.assign(orderMessages["zh-TW"], {
  ...
  orderTo: "到",
  orderApplyFilter: "套用",
  orderFilterReset: "清除篩選",
  orderPreviousDay: "前一天",
  orderNextDay: "後一天",
  adminOrdersAmount: "總金額",
  adminOrdersTotal: "總數",
  previousPage: "上一頁",
  nextPage: "下一頁",
  adminOrdersTime: "時間",
...
Object.assign(promotionMessages.vi as Record<string, string>, {
    ...
    searchAddon: "Tìm theo tên add-on...",
    searchProduct: "Tìm theo tên sản phẩm...",
    searchCategory: "Tìm theo tên danh mục...",
});
Object.assign(promotionMessages.en as Record<string, string>, {
    searchPromotionTargets: "Search products or add-ons",
    searchAddon: "Search add-ons by name...",
    searchProduct: "Search products by name...",
    searchCategory: "Search categories by name...",
});
Object.assign(promotionMessages["zh-TW"] as Record<string, string>, {
    searchPromotionTargets: "搜尋商品或加料",
    searchAddon: "依加料名稱搜尋...",
    searchProduct: "依商品名稱搜尋...",
    searchCategory: "依分類名稱搜尋...",
});
...
const revenueMessages = {
  vi: {
    revenueFrom: "T\u1eeb",
    revenueTo: "\u0110\u1ebfn",
    revenueApplyFilter: "\u00c1p d\u1ee5ng",
    revenueFilterReset: "X\u00f3a b\u1ed9 l\u1ecdc",
    revenuePreviousDay: "Ng\u00e0y tr\u01b0\u1edbc",
    revenueNextDay: "Ng\u00e0y sau",
    revenueTableTitle: "Bảng Thu Nhập Khác",
    totalOtherRevenue: "Tổng",
  ...
  en: {
    revenueFrom: "From",
    revenueTo: "To",
    revenueApplyFilter: "Apply",
    revenueFilterReset: "Clear filters",
    revenuePreviousDay: "Previous day",
    revenueNextDay: "Next day",
    revenueTableTitle: "Other Revenue",
    totalOtherRevenue: "Total",
  ...
  "zh-TW": {
    revenueFrom: "\u5f9e",
    revenueTo: "\u5230",
    revenueApplyFilter: "\u5957\u7528",
    revenueFilterReset: "\u6e05\u9664\u7be9\u9078",
    revenuePreviousDay: "\u524d\u4e00\u5929",
    revenueNextDay: "\u5f8c\u4e00\u5929",
    revenueTableTitle: "其他收入",
    totalOtherRevenue: "總計",
...
const expenseMessages = {
  vi: {
    ...
    expenseName: "Tên",
    expenseType: "Loại",
    expenseCategory: "Nhóm chi phí",
    expenseCategoryIngredient: "Nguyên liệu",
    expenseCategoryOther: "Khác",
    expenseCategoryUtilities: "Điện nước",
    expenseCategoryRent: "Thuê mặt bằng",
    expenseCategoryTransport: "Vận chuyển",
    expenseCategoryMaintenance: "Sửa chữa",
    expenseCategorySalary: "Nhân sự",
    expensePrice: "Giá",
  ...
  en: {
    ...
    expenseCategoryIngredient: "Ingredients",
  ...
  "zh-TW": {
    ...
    expenseCategoryIngredient: "原料",
    expenseCategoryOther: "其他",
    expenseCategoryUtilities: "水電",
    expenseCategoryRent: "租金",
    expenseCategoryTransport: "運輸",
    expenseCategoryMaintenance: "維修",
    expenseCategorySalary: "人事",
    expensePrice: "價格",
    expenseNote: "備註",
    expenseActions: "操作",
...
const closingRangeMessages = {
  vi: {
    closingFilterFrom: "T\u1eeb",
    closingFilterTo: "\u0110\u1ebfn",
    closingApplyFilter: "\u00c1p d\u1ee5ng",
    closingPreviousDay: "Ng\u00e0y tr\u01b0\u1edbc",
    closingNextDay: "Ng\u00e0y sau",
  },
  en: {
    closingFilterFrom: "From",
    closingFilterTo: "To",
    closingApplyFilter: "Apply",
    closingPreviousDay: "Previous day",
    closingNextDay: "Next day",
  },
  "zh-TW": {
    closingFilterFrom: "\u5f9e",
    closingFilterTo: "\u5230",
    closingApplyFilter: "\u5957\u7528",
    closingPreviousDay: "\u524d\u4e00\u5929",
    closingNextDay: "\u5f8c\u4e00\u5929",
  },
} as const;
