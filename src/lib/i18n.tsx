...
const messages: Record<Locale, Record<string, string>> = {
  vi: {
    ...
    lineGroupsHint: "Phát hiện group qua webhook, sau đó Super Admin gán cửa hàng và cấu hình thông báo.",
    lineGroupsAdminHint: "Group mới mặc định bị tắt cho đến khi được cấu hình.",
    ...
    lineNotificationNewOrder: "Đơn hàng mới",
  ...
  en: {
    ...
    lineGroupsHint: "Groups are discovered through the webhook, then assigned and configured by a Super Admin.",
    lineGroupsAdminHint: "New groups are disabled until configured.",
    ...
    lineNotificationNewOrder: "New orders",
  ...
  "zh-TW": {
    ...
    dailyClosing: "日結",
    lineGroups: "LINE 群組",
    lineGroupsHint: "群組會透過 Webhook 自動發現，再由 Super Admin 指派分店並設定通知。",
    lineGroupsAdminHint: "新群組完成設定前會保持停用。",
