    ...
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-background/55 backdrop-blur-[2px]">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex items-center gap-1.5 text-sm font-medium text-muted-foreground">
          <span>{t("loading")}</span>
          <span className="animate-[loading-dot_1.4s_ease-in-out_infinite]">
            .
          </span>
          <span className="animate-[loading-dot_1.4s_0.2s_ease-in-out_infinite]">
            .
          </span>
          <span className="animate-[loading-dot_1.4s_0.4s_ease-in-out_infinite]">
            .
          </span>
        </div>
      </div>
