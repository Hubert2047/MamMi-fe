...
export const updateStoreItem = async ({ itemId, data }: { itemId: string; data: Partial<{ price: PriceType; permanentlyActive: boolean; temporarilyUnavailable: boolean }> }) => (await api.put(`store-items/${itemId}`, data)).data.data
